...
return array(
    ...
    'PHP_CodeCoverage' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage.php',
    'PHP_CodeCoverage_Driver' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Driver.php',
    'PHP_CodeCoverage_Driver_Xdebug' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Driver/Xdebug.php',
    'PHP_CodeCoverage_Exception' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Exception.php',
    'PHP_CodeCoverage_Filter' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Filter.php',
    'PHP_CodeCoverage_Report_Clover' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/Clover.php',
    'PHP_CodeCoverage_Report_Factory' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/Factory.php',
    'PHP_CodeCoverage_Report_HTML' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/HTML.php',
    'PHP_CodeCoverage_Report_HTML_Renderer' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/HTML/Renderer.php',
    'PHP_CodeCoverage_Report_HTML_Renderer_Dashboard' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/HTML/Renderer/Dashboard.php',
    'PHP_CodeCoverage_Report_HTML_Renderer_Directory' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/HTML/Renderer/Directory.php',
    'PHP_CodeCoverage_Report_HTML_Renderer_File' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/HTML/Renderer/File.php',
    'PHP_CodeCoverage_Report_Node' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/Node.php',
    'PHP_CodeCoverage_Report_Node_Directory' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/Node/Directory.php',
    'PHP_CodeCoverage_Report_Node_File' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/Node/File.php',
    'PHP_CodeCoverage_Report_Node_Iterator' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/Node/Iterator.php',
    'PHP_CodeCoverage_Report_PHP' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/PHP.php',
    'PHP_CodeCoverage_Report_Text' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Report/Text.php',
    'PHP_CodeCoverage_Util' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Util.php',
    'PHP_CodeCoverage_Util_InvalidArgumentHelper' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Util/InvalidArgumentHelper.php',
    'PHP_CodeCoverage_Version' => $vendorDir . '/phpunit/php-code-coverage-html/PHP/CodeCoverage/Version.php',
    ...
    'calculadora3' => $baseDir .'/app/libraries/calculadora3.php',
);
