...
class Tests_Selenium2TestCase_Coverage_RemoteCoverageTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $coverageScriptUrl = PHPUNIT_TESTSUITE_EXTENSION_SELENIUM_TESTS_URL . '/coverage-html/dummy.txt';
    ...
    private function classSourceFile($className, array $content)
    {
        ...
        $this->fail("Class $className not found in coverage-html: " . var_export($content, true));
    }
}
